<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SessionExpire.aspx.cs" Inherits="Login" %>
...
<head  runat="server">
    ...
    <title>Session Expire - Pages |B2Traders</title>

    <meta name="description" content="Achieve new heights of SUCCESS in life Start your on BUSINESS" />
    <meta name="keywords" content="B2Traders, businessB2Traders, Session ">
    <!-- Canonical SEO -->
    ...
    <link rel="stylesheet" href="../Loginassets/vendor/libs/perfect-scrollbar/perfect-scrollbar.css" />
     ...
     <link rel="stylesheet" href="../Loginassets/vendor/css/pages/page-misc.css">
    <!-- Helpers -->
...
<div class="container-xxl container-p-y" >
  <div class="misc-wrapper">
    <h2 class="mb-2 mx-2">Your Session is expired :(</h2>
    <p class="mb-4 mx-2">Oops! 😖 You're being timed out due to inactivity..</p>
    <a href="Login.aspx" class="btn btn-primary">Back to Login</a>
    <div class="mt-3">
      <img src="../Loginassets/img/illustrations/page-misc-error-light.png" alt="page-misc-error-light" width="500" class="img-fluid" data-app-dark-img="illustrations/page-misc-error-dark.png" data-app-light-img="illustrations/page-misc-error-light.png">
    </div>
  </div>
</div>
<!-- /Error -->
