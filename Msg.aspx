<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Msg.aspx.cs" Inherits="forgotpassword" %>
...
<head  runat="server">
    ...
    <title>Successfully Registration - Page |B2Traders</title>
            ...
            <div class="authentication-inner">
                ...
                <div class="card">
                   <div class="card-body" style=" -webkit-box-shadow: 0px 0px 10px 5px rgba(255,255,255,1); -moz-box-shadow: 0px 0px 10px 5px rgba(255,255,255,1); box-shadow: 0px 0px 10px 5px #000000;">
                        ...
                        <!-- /Logo -->
                        <h4 class="mb-2">Congratulations Dear! <asp:Label runat="server" CssClass="text-danger" id="lbname" ></asp:Label>  </h4>
                        <p class="mb-4">Successfully Created Your Account! </p>

                        <div id="formAuthentication" class="mb-3" ">
                            <div class="mb-3">
                                <label for="email" class="form-label">Your ID</label>
                                 <asp:TextBox ID="lbusername" runat="server" CssClass="form-control" ReadOnly="true"></asp:TextBox>
                            </div>
                            <div class="mb-3">
                                <label for="email" class="form-label">Your Password</label>
                                 <asp:TextBox ID="lbpassword" runat="server" CssClass="form-control" ReadOnly="true"></asp:TextBox>
                            </div>
                             <div class="mb-3">
                                <label for="email" class="form-label">Your Trans Password</label>
                                 <asp:TextBox ID="lbtranspassword" ReadOnly="true" runat="server" CssClass="form-control" ></asp:TextBox>
                            </div>
                           
                             <asp:Label ID="lbmsg" Text="" CssClass="label label-danger" runat="server"></asp:Label>
                
                            <div class="mb-3">
                                 <asp:Button runat="server" ID="btnLogin" CssClass="btn btn-info d-grid w-100" OnClick="btnLogin_Click"   Text="Login Now!" style=" background: radial-gradient(circle,rgba(70, 87, 171, 1) 37%, rgba(224, 52, 86, 0.29) 99%) !important;"/>
