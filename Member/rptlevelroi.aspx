<%@ Page Title="" Language="C#" MasterPageFile="~/Member/MasterPage.master" AutoEventWireup="true" CodeFile="rptlevelroi.aspx.cs" Inherits="User_Default2" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     ...
     <div class="card">
            <div class="card-header">
              <h5 class="card-title"> Direct Sharing Profit  </h5>
...
<asp:TemplateField HeaderText="#">
                ...
                <asp:boundfield DataField="Credit" HeaderText="Credit(USDT)"></asp:boundfield>
                <asp:boundfield DataField="Debit" HeaderText="Debit(USDT)"></asp:boundfield>
