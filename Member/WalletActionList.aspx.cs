...
public partial class Member_WalletApprovedList : System.Web.UI.Page
{
    ...
    public void loaddirect()
    {
        try
        {
            ...
            string sql = "select * from [TblRepurchaseRequest] where  username='" + SessionData.Get<string>("newuser") + "' ";
