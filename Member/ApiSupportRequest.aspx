<%@ Page Title="" Language="C#" MasterPageFile="~/member/MasterPage.master" AutoEventWireup="true" CodeFile="ApiSupportRequest.aspx.cs" Inherits="User_Support1" %>
            ...
            <div class="container-fluid">--%>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0">Trading API Key Request</h4>
              ...
              <div class="card">
                         ...
                         <asp:TextBox ID="txtSubject"  placeholder="Enter Subject" required="" runat="server" CssClass="form-control"></asp:TextBox>
                                          ...
                                          <br />
                      <div class="form-group row">
                          <label class="control-label col-lg-2">Request </label>
                          <div class="col-lg-6">
