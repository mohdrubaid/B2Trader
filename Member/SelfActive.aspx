...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
      ...
      <div class="row">
        ...
        <div class="col-lg-12">
         ...
         <hr />
                     ...
                     <%--  <div class=" mb-3 row">
                         <label class="control-label col-sm-2">Minimum Amount($) </label>
                           <div class="col-sm-4">
                         <asp:TextBox ID="txtmin" runat="server" ReadOnly="true" Text="0" CssClass=" form-control"  ></asp:TextBox>
                             
                          </div>
                             <label class="control-label col-sm-2">Maximum Amount($) </label>
                          <div class="col-sm-4">
   ...
   <asp:Button ID="btnaction" runat="server" Text="Invest Now"  OnClientClick="return confirmAction();" OnClick="butsubmit_Click"   CssClass="btn bg-success text-white"/>
