...
<head  runat="server">
    ...
    <title>Login-Page ||B2Traders</title>
            ...
            <div class="authentication-inner">
                ...
                <div class="card">
                    <div class="card-body" style=" -webkit-box-shadow: 0px 0px 10px 5px rgba(255,255,255,1); -moz-box-shadow: 0px 0px 10px 5px rgba(255,255,255,1); box-shadow: 0px 0px 10px 5px #000000;">
                        ...
                        <p class="mb-4">Lets's Continue By Login to Your Account!!</p>
                        ...
                        <div id="formAuthentication" class="mb-3" ">
                            ...
                            <div class="mb-3">
                                 <asp:Button runat="server" ID="btnLogin" CssClass="btn btn-info d-grid w-100" OnClick="btnLogin_Click"   Text="LogIn" style=" background: radial-gradient(circle,rgba(70, 87, 171, 1) 37%, rgba(224, 52, 86, 0.29) 99%) !important;"/>
                        ...
                        <p class="text-center">
                            <span>New on our B2Traders?</span>
                            <a href="Signup.aspx">
