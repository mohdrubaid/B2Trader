...
public partial class Admin_rptlevelIncome : System.Web.UI.Page
{
    ...
    private void loadlist()
    {
        try
        {
            string sql = "select r.name,r.dateofjoin,a.username,sum(cast (a.credit as real)) as totalincome from register r inner join account a on r.username=a.username  where a.valu='Level' ";
    ...
    protected void Repeater1_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        if (e.CommandName == "View")
        {
            ...
            Response.Redirect("rptViewIncome.aspx?username=" + username + "&type=Level");
        }
    }
    protected void btnExportToExcel_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            Response.AddHeader("content-disposition", "attachment;filename=LevelIncome.xls");
            Response.Charset = "";
    ...
    public void ExportToPdf()
    {
        ...
        Response.AddHeader("content-disposition", "attachment;filename=LevelIncome.pdf");
