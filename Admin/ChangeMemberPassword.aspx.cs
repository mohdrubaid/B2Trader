...
public partial class Admin_ChangeMemberPassword : System.Web.UI.Page
{
    ...
    protected void bntsubmit_Click(object sender, EventArgs e)
    {
        try
        {
            if (txtnewpass.Text == txtconpass.Text)
            {
                ...
                string sql =  "update register set password='" + txtnewpass.Text + "' where username='" + hndusername.Value + "' ";
