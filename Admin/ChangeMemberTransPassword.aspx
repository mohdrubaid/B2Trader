<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="ChangeMemberTransPassword.aspx.cs" Inherits="Admin_ChangeMemberTransPassword" %>
              ...
              <div class="page-content">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0">Member Transaction Password Change</h4>

                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                             <%--<li class="breadcrumb-item"><a href="javascript: void(0);">Minible</a></li>--%>
                                            <li class="breadcrumb-item active"><a href="Home.aspx">Home</a>/Member Transaction Password Change</li>
                                        </ol>
                                    </div>
               ...
               <!-- Alret-->
                                            ...
                                            <div class="alert alert-success alert-dismissible fade show" role="alert"  id="sccess" runat="server" visible="false" >
                                                ...
                                                <asp:Label ID="lbsuccess" runat="server" Text="Transaction Password has changed"></asp:Label>  
                                            ...
                                            <div class="alert alert-danger alert-dismissible fade show" role="alert" id="danger"  runat="server"  visible="false">
                                                <i class="uil uil-exclamation-octagon me-2"></i>
                                                  <asp:Label ID="lbdanger" runat="server" Text="Transaction Password has not changed"></asp:Label> 
                                                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close">
