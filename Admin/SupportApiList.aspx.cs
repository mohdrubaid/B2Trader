...
public partial class Admin_SupportLIst : System.Web.UI.Page
{
    ...
    {
        try {
            string sql = "select * from TblSupportAPI  order by DOI desc";
    ...
    protected void Repeater1_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        ...
        if (e.CommandName == "Click")
        {
            ...
            string sql = "update  TblSupportAPI set status='Approved',response='" + lbresponsce.Text + "' where sid='"+e.CommandArgument.ToString()+"'";
       ...
       protected void btnExportToExcel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Response.AddHeader("content-disposition", "attachment;filename=SupportApiList.xls");
                Response.Charset = "";
