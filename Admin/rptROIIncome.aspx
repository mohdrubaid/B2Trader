<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/MasterPage.master" AutoEventWireup="true" CodeFile="rptROIIncome.aspx.cs" Inherits="Admin_rptlevelIncome" %>
    ...
    <div class="form-horizontal">
        <div class="card-body">
            <div class=" form-group row">
                <div class=" col-lg-8">
                    <h2 class="card-title">Compund Profit</h2>
                </div>
                            ...
                            <ItemTemplate>
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="rptViewIncome.aspx?username=<%#Eval("username") %>&type=ROI" text="View" class="btn  btn-block  btn-warning">View</a>
                                        </td>
                                    </tr>
                                </tbody>
                            </ItemTemplate>
